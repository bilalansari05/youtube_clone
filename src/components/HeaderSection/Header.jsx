  ...
  return (
    ...
    >
      ...
      <div className="flex items-center group relative">
        <div
          className={`flex h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-within:pl-0 ${
        ...
        <button
          className={`flex items-center justify-center w-[44px] md:w-[60px] h-10 rounded-r-3xl border border-l-0 ${
            isDarkMode ? "border-gray-700" : "border-gray-300"
        ...
        <button
          className={`flex items-center justify-center w-[44px] md:w-[60px] h-8 md:h-10 rounded-full hover:bg-${
            isDarkMode ? "gray-700" : "gray-300"
          } ml-2`}
          onClick={() => {
            if(listening){
